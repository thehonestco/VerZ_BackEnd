...
<div class="main-content-wrap">
	<div class="flex items-center flex-wrap justify-between gap20 mb-27">
		...
		<ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
			...
			<li>
				<div class="text-tiny">Store Admin List</div>
			</li>
		</ul>
	</div>
	<!-- order-list -->
	<div class="wg-box">
		<div class="flex items-center justify-between gap10 flex-wrap">
			...
			<a class="tf-button style-1 w208" href="{{route('superadmin.store-admin.create')}}"><i class="icon-file-text"></i>Add New Admin</a>
		</div>
			...
			<ul class="flex flex-column " style="min-width:100% !important;">
				...
				<li class="product-item gap14" >
					<div class="flex items-center justify-between gap20 flex-grow">
						<div class="body-text" style="width:50px !important;">{{$user->id}}</div>
						...
						<div class="list-icon-function">
							<div class="item eye">
								<a title="View Details" href="{{route('superadmin.store-admin.show', $user->id)}}"><i class="icon-eye"></i></a>
							</div>
							<div class="item edit">
								<a title="Edit Item" href="{{route('superadmin.store-admin.edit', $user->id)}}"><i class="icon-edit-3"></i></a>
							</div>
